export default defineNuxtConfig({
    ...
    app: {
        ...
        head: {
            ...
            meta: [
                ...
                { property: 'og:image', content: 'https://pan.junew.cn/logo.png' },
                { property: 'og:url', content: 'https://pan.junew.cn' },
                { name: 'twitter:card', content: 'summary_large_image' },
                { name: 'twitter:title', content: '轻盘搜：资源随心，音乐下载与影视聚合平台' },
                { name: 'twitter:description', content: '免费开源的资源搜索平台，涵盖音乐、网盘、影视等内容，学习探索好去处！' },
                { name: 'twitter:image', content: 'https://pan.junew.cn/logo.png' },
    ...
    site: {
        name: '轻盘搜 - 资源随心，娱乐无限',
        url: 'https://pan.junew.cn',
        description: '轻盘搜 - 资源随心，娱乐无限， 一个开源免费的网盘资源搜索程序，仅供学习使用，不支持商业用途。'
    },
